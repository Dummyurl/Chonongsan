package vn.phatduong.chonongsan.constants;
...
public interface Constants {
    ...
    public static final String WEB_SITE = "http://marketplace.ifsoft.ru/";  //web site url address

    public static final String CLIENT_ID = "1";  //Client ID | For identify the application | Example: 12567

    public static final String API_DOMAIN = "http://marketplace.ifsoft.ru/";  //url address to which the application sends requests
